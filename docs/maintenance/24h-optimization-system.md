...
### 前端交互优化队列 (v2.04)
- [ ] B11: AI 聊天气泡 UI 升级 — 气泡美化 + Markdown渲染 + 长消息优化 ⏳ 执行中
- [ ] B12: 日历滑动体验优化 — 手势切换 + 日期标记 + 今日高亮 ⏳ 执行中

### 安全加固队列 (v2.05)
- [ ] B13: 安全加固 — TEST_MODE断言 + db clear防护 + whereEx限制 ⏳ 执行中
- [ ] B14: TabBar 微交互 + 全局加载状态统一
- [ ] B15: Object 字段白名单 — service 层 DTO 模式防注入

### 新方向探索队列 (v2.04+)
- [ ] B16: 微信小程序离线能力 — 离线缓存 + 数据预加载 + 网络恢复策略
- [ ] B17: 暗黑模式支持 — CSS 变量主题切换
